...
for alpha in range(0, 4):
    for n in range(-10, 9):
        arc((loutus_x_center_inverse(n, alpha*np.pi/2), loutus_y_center_inverse(n, alpha*np.pi/2)), (loutus_x_from_inverse(n, alpha*np.pi/2), loutus_y_from_inverse(n, alpha*np.pi/2)),
            (loutus_x_to_inverse(n, alpha*np.pi/2), loutus_y_to_inverse(n, alpha*np.pi/2)), 'r')
