...
def onepetal(n, thelta, color):
    arc((waterlily_x_center_left(n, thelta=0), waterlily_y_center_left(n, thelta=0)), (0, 0),
        (waterlily_x_from(n, thelta=0), waterlily_y_from(n, thelta=0)), color)
    arc((waterlily_x_center_right(n, thelta=0), waterlily_y_center_right(n, thelta=0)),
        (waterlily_x_from(n, thelta=0), waterlily_y_from(n, thelta=0)), (0, 0), color)
